...
const LEVELS = [
  ...
  { id:8, op:'w', grp:'chain', d:2, eq:'2 + 6 − 5', desc:'A long chain of + and −, worked left to right', also:['mbg-autumn-2025-2'], gen:genChain },
  { id:9, op:'w', grp:'chain', needs:[8], d:3, eq:'1 + 9 + 2 + 8', desc:'Chains that simplify by grouping — into tens, ± pairs, or terms that cancel', also:['mbg-autumn-2025-2'], gen:genPairs },
  ...
  { id:12, op:'w', grp:'count', d:3, eq:'Колко? Сбор?', desc:'How many — or the sum — of a range given by a condition', also:['mbg-autumn-2025-2', 'mbg-winter-2024-2'], gen:genCount },
  ...
  { id:13, op:'w', grp:'num', d:3, eq:'Най-малкото', desc:'Smallest two-digit, largest one-digit, then compare', also:['mbg-autumn-2025-2'], gen:genNamed },
  ...
  { id:11, op:'w', grp:'find', d:3, eq:'6 − ◯', desc:'Find the hidden number — or two of them — then use it', also:['mbg-autumn-2025-2'], gen:genBox },
  { id:15, op:'w', grp:'find', d:4, eq:'Кое изтрих?', desc:'Spot the number a few more — or a few less — than another', also:['mbg-autumn-2025-2'], gen:genErase },
  ...
  { id:10, op:'w', grp:'word', needs:[5], d:3, eq:'С колко?', desc:'How much bigger one sum is than the other', also:['mbg-autumn-2025-2'], gen:genCmp },
  ...
  { id:22, op:'w', grp:'geo', needs:[21], d:4, eq:'Обща страна', desc:'Two figures share an edge — what it costs the outline', also:['mbg-autumn-2025-2'], gen:genShared },
