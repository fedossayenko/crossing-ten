...
const LEVELS = [
  ...
  { id:9, op:'w', grp:'chain', needs:[8], d:3, eq:'1 + 9 + 2 + 8', desc:'Chains that simplify by grouping — into tens, ± pairs, or terms that cancel', also:['mbg-autumn-2024-2', 'mbg-autumn-2025-2'], gen:genPairs },
  ...
  { id:12, op:'w', grp:'count', d:3, eq:'Колко? Сбор?', desc:'How many — or the sum — of a range given by a condition', also:['mbg-autumn-2024-2', 'mbg-autumn-2025-2', 'mbg-winter-2024-2'], gen:genCount },
  ...
  { id:16, op:'w', grp:'count', needs:[12,2], d:5, eq:'Вместо ?', desc:'How many digits make the statement false', also:['mbg-autumn-2025-2', 'mbg-winter-2024-2'], gen:genIneq },
  ...
  { id:13, op:'w', grp:'num', d:3, eq:'Най-малкото', desc:'Smallest two-digit, largest one-digit, then compare', also:['mbg-autumn-2024-2', 'mbg-autumn-2025-2'], gen:genNamed },
  ...
  { id:18, op:'w', grp:'num', d:4, eq:'Сбор на цифрите', desc:'How many two-digit numbers have a given digit sum', also:['mbg-autumn-2025-2', 'mbg-winter-2024-2', 'kms-2025-2'], gen:genDigits },
  ...
  { id:27, op:'w', grp:'seq', d:4, eq:'Пропуснатите', desc:'Find the rule, fill the gaps — then read what is asked', also:['mbg-autumn-2024-2'], gen:genMissing },
  { id:26, op:'w', grp:'seq', d:4, eq:'Редица', desc:'Smaller on the left, bigger on the right', also:['mbg-autumn-2025-2'], gen:genSeq },
  { id:11, op:'w', grp:'find', d:3, eq:'6 − ◯', desc:'Find the hidden number — or two of them — then use it', also:['mbg-autumn-2024-2', 'mbg-autumn-2025-2'], gen:genBox },
  ...
  { id:10, op:'w', grp:'word', needs:[5], d:3, eq:'С колко?', desc:'How much bigger one sum is than the other', also:['mbg-autumn-2024-2', 'mbg-autumn-2025-2'], gen:genCmp },
  ...
  { id:21, op:'w', grp:'geo', d:4, eq:'Обиколка', desc:'Squares, sheets and triangles — sides and perimeters', also:['mbg-autumn-2025-2'], gen:genSqCut },
  ...
  { id:19, op:'w', grp:'geo', d:4, eq:'Правоъгълници', desc:'How many rectangles in the grid hold the ant', also:['mbg-autumn-2025-2', 'mbg-winter-2024-2'], gen:genRects },
